...
class GPUTPCTracker : public GPUProcessor
{
 public:
  ...
  {
    // param.GetClusterErrors2( iRow, param.GetContinuousTracking() != 0. ? 125.f : t.Z(), t.SinPhi(), t.DzDs(), ErrY2, ErrZ2 );
  ...
  {
    // Param().GetClusterErrors2( iRow, Param().GetContinuousTracking() != 0. ? 125.f : z, sinPhi, DzDs, ErrY2, ErrZ2 );
