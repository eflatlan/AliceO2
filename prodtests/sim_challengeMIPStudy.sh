...
o2-sim -n"$nev" -e TGeant3 -g boxgen --configKeyValues "BoxGun.pdg=211; BoxGun.phirange[0]=27.4; BoxGun.phirange[1]=27.6; BoxGun.number=1; BoxGun.eta[0]=-0.01; BoxGun.eta[1]=0.01; BoxGun.prange[0]=2.999; BoxGun.prange[1]=3.001;" $simWorker --run ${runNumber}
...
o2-sim -n"$nev" -e TGeant3 -g boxgen --configKeyValues "BoxGun.pdg=321; BoxGun.phirange[0]=27.4; BoxGun.phirange[1]=27.6; BoxGun.number=1; BoxGun.eta[0]=-0.01; BoxGun.eta[1]=0.01; BoxGun.prange[0]=2.999; BoxGun.prange[1]=3.001;" $simWorker --run ${runNumber}
...
o2-sim -n"$nev" -e TGeant3 -g boxgen --configKeyValues "BoxGun.pdg=2212; BoxGun.phirange[0]=27.4; BoxGun.phirange[1]=27.6; BoxGun.number=1; BoxGun.eta[0]=-0.01; BoxGun.eta[1]=0.01; BoxGun.prange[0]=2.999; BoxGun.prange[1]=3.001;" $simWorker --run ${runNumber}
