...
class ClusterTopology
{
 public:
  ...
  /// Returns the pattern
  const std::array<unsigned char, ClusterPattern::kExtendedPatternBytes>& getPattern() const { return mPattern.getPattern(); }
  const ClusterPattern& getClusterPattern() const { return mPattern; }
