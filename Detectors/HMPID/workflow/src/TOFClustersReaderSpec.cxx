...
DataProcessorSpec getClusterReaderSpec(bool useMC)
{
  ...
  outputs.emplace_back(o2::header::gDataOriginHMP, "CLUSTERS", 0, Lifetime::Timeframe);
 
  outputs.emplace_back(o2::header::gDataOriginTOF, "INTRECORDS1", 0, Lifetime::Timeframe);
  ...
  return DataProcessorSpec{
    ...
    Options{
      {"tof-cluster-infile", VariantType::String, "hmpidclusters.root", {"Name of the input file"}},
